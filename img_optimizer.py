...
""" python script to optimze images from the assets directory in a app"""
""" refer to [https://github.com/Anslem27/flutter-image-assets-optimizer] for more documentation """
